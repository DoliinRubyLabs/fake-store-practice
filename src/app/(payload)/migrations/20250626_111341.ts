...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "layout_blocks_header_buttons" ADD CONSTRAINT "layout_blocks_header_buttons_icon_id_images_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "layout_blocks_header" ADD CONSTRAINT "layout_blocks_header_logo_id_images_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "layout_blocks_footer" ADD CONSTRAINT "layout_blocks_footer_logo_id_images_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_layout_v_blocks_header_buttons" ADD CONSTRAINT "_layout_v_blocks_header_buttons_icon_id_images_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_layout_v_blocks_header" ADD CONSTRAINT "_layout_v_blocks_header_logo_id_images_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_layout_v_blocks_footer" ADD CONSTRAINT "_layout_v_blocks_footer_logo_id_images_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_text_content" ADD CONSTRAINT "pages_blocks_text_content_image_id_images_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_text_content" ADD CONSTRAINT "_pages_v_blocks_text_content_image_id_images_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."images"("id") ON DELETE set null ON UPDATE no action;
